...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/skorch-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=5248&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/skorch-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `skorch` can be installed with:

```
conda install skorch
```

It is possible to list all of the versions of `skorch` available on your platform with:
